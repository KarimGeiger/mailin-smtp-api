...
class Mailin
{
    ...
    private $username, $password, $webaction, $wba, $domain;
    private $to_list,
        $from,
        $from_name,
        $reply_to,
     ...
     * @param string $name - name for single email address
     * @return self The Mailin object.
     */
     ...
     * @param boolean $as_array - return the from as an associative array
     * @return array|string The from email address
     */
     ...
     * @param array $email_list (array('name' => 'abc', 'email' => 'abc@mailin.fr')) - a list of email addresses
     * @return self The Mailin object.
     */
     ...
     * @param array $email_list ex(array('name' => 'abc', 'email' => 'abc@mailin.fr')) - the list of email recipients to
     * @return self The Mailin object.
     */
     ...
     * @return string The HTML part of the email.
     */
     ...
     * @param array $filter_settings - array of filter settings
     * @return self the Mailin object.
     */
     ...
     * send
     * Send an email
     * @param boolean $parse_json Parse json or just return raw output
     * @return string|object the json response
     */
    public function send($parse_json = false)
    {
        ...
        // try to parse response, if requested; return string on failure
        if ($parse_json && $parsed = json_decode($response)) {
            $response = $parsed;
        }
